...
const totalCalories = (restaurants.mcDonalds.entree[entree].calories * entreeAmount) + (restaurants.mcDonalds.side[side].calories * sideAmount);
const totalProtein = (restaurants.mcDonalds.entree[entree].protein * entreeAmount) + (restaurants.mcDonalds.side[side].protein * sideAmount);
const totalCarbs = (restaurants.mcDonalds.entree[entree].carbs * entreeAmount) + (restaurants.mcDonalds.side[side].carbs * sideAmount);
const totalFat = (restaurants.mcDonalds.entree[entree].fat * entreeAmount) + (restaurants.mcDonalds.side[side].fat * sideAmount);
